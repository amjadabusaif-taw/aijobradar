...
const guides = [
  { cluster: 'Universal', title: 'AI-Proof Your Career', sub: 'Your career is changing whether you\u2019re ready or not.', cover: '/covers/cover-1.jpg', slug: 'ai-proof-career', price: '$27', badge: 'Bestseller', audience: 'For any professional facing AI disruption.', includes: ['Career Resilience Audit', 'Adaptive Positioning Framework', '90-Day Action Plan', '22 pages'] },
  { cluster: 'Client-Facing', title: 'The Client-Facing AI Survival Guide', sub: 'When the chatbot handles the easy ones, you handle the ones that matter.', cover: '/covers/cover-2.jpg', slug: 'client-facing', price: '$27', audience: 'For Customer Service, Account Managers, Sales Professionals, and Support Specialists.', includes: ['Relationship-Over-Transaction Audit', 'Client Trust Framework', '90-Day Action Plan', '17 pages'] },
  { cluster: 'Creative', title: 'The Creative Professional\u2019s AI Playbook', sub: 'When the machine can make it, your job is to mean it.', cover: '/covers/cover-3.jpg', slug: 'creative-playbook', price: '$27', audience: 'For Content Creators, Video Producers, Social Media Managers, and Copywriters.', includes: ['Direction-Over-Production Audit', 'Creative Authority Framework', '90-Day Action Plan', '16 pages'] },
  { cluster: 'Education', title: 'AI-Proofing Education', sub: 'When the lesson plans write themselves, your job is to teach what they can\u2019t.', cover: '/covers/cover-4.jpg', slug: 'education-ai-proof', price: '$27', audience: 'For Teachers, Researchers, Academic Administrators, and Instructional Designers.', includes: ['Mentorship-Over-Delivery Audit', 'Human Impact Framework', '90-Day Action Plan', '16 pages'] },
  { cluster: 'Technical', title: 'The Technical Professional\u2019s AI Displacement Guide', sub: 'When the builders get built for.', cover: '/covers/cover-5.jpg', slug: 'technical-displacement', price: '$27', audience: 'For Software Developers, Data Engineers, IT Administrators, and Cybersecurity Specialists.', includes: ['Implementation-to-Architecture Audit', 'Force Multiplier Framework', '90-Day Action Plan', '15 pages'] },
  { cluster: 'Finance', title: 'The Finance Professional\u2019s AI Displacement Guide', sub: 'When the numbers start running themselves.', cover: '/covers/cover-6.jpg', slug: 'finance-displacement', price: '$27', audience: 'For Financial Analysts, Accountants and Auditors, Risk and Compliance Professionals, and Banking Specialists.', includes: ['Judgment-Over-Calculation Audit', 'Advisory Upgrade Framework', '90-Day Action Plan'] },
  { cluster: 'Legal', title: 'The Legal Professional\u2019s AI Displacement Guide', sub: 'When the fine print reads itself.', cover: '/covers/cover-7.jpg', slug: 'legal-displacement', price: '$27', audience: 'For Lawyers, Paralegals, Compliance Officers, and In-House Counsel.', includes: ['Judgment-Over-Process Audit', 'Advisory Shift Framework', '90-Day Action Plan'] },
  { cluster: 'Healthcare & Public Sector', title: 'The Healthcare & Public Sector AI Displacement Guide', sub: 'When the system starts thinking for itself.', cover: '/covers/cover-8.jpg', slug: 'healthcare-public-sector', price: '$27', audience: 'For Healthcare Administrators, Programme Managers, Policy Analysts, and Grant Coordinators.', includes: ['Service-Over-Process Audit', 'Human Judgment Framework', '90-Day Action Plan'] },
  { cluster: 'Built Environment', title: 'The Built Environment AI Displacement Guide', sub: 'When the blueprints draw themselves.', cover: '/covers/cover-9.jpg', slug: 'built-environment', price: '$27', audience: 'For Architects, Civil Engineers, Quantity Surveyors, and Construction Project Managers.', includes: ['Design-Over-Drafting Audit', 'Judgment Integration Framework', '90-Day Action Plan'] },
];
            ...
            <div key={i} className="g-card" onClick={() => setModal(g)}>
              ...
              <div className="g-card-body">
                ...
                <div className="g-card-foot">
                  ...
                  <a className="g-btn gumroad-button" target="_blank" rel="noopener" href={`${G}/${g.slug}`} onClick={(e) => e.stopPropagation()}>Buy Now</a>
                </div>
              </div>
            </div>
          ))}
        ...
        <section className="g-bundle" id="bundle">
          <div className="g-bundle-inner">
            <div>
              ...
              <div className="g-bundle-price">$97 <span>$243</span></div>
            </div>
            <a className="g-btn-lg gumroad-button" target="_blank" rel="noopener" href={`${G}/aijobradar-bundle`}>Get the Bundle</a>
          </div>
        </section>
            ...
            <div className="g-modal">
              ...
              <div className="g-modal-right">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
                  ...
                  <a className="g-btn-lg gumroad-button" target="_blank" rel="noopener" href={`${G}/${modal.slug}`}>Get the Guide</a>
                </div>
              </div>
            </div>
          </div>
